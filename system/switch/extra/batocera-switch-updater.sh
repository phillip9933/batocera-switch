         ...
         ####################################################################
            u=/userdata/system/switch/extra/batocera-switch-desktopupdater.sh
               rm "$u" 2>/dev/null
                  ...
                  echo "  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /tmp/.batocera-switch-updater.sh https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-updater.sh" >> "$u"
                  ##echo "  curl -sSf https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-updater.sh -o /tmp/.batocera-switch-updater.sh " >> "$u"
...
wget -q --show-progress --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/sudachi.zip" "https://dl.buzzheavier.com/1849415499292692480?v=1729770858-2CGtEZdycDmnWapcJo%2FBzkwnOWJJ0ps%2F5qn1QMTOj%2FY%3D"
...
url_updater=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-updater.sh

...
#                   ----------------------------------------                   #
#                     > github.com/phillip9933/batocera-switch                   #
#                                                                              #     
################################################################################
#  ---------------
#     SETTINGS 
         ...
         ####################################################################
            u=/userdata/system/switch/extra/batocera-switch-desktopupdater.sh
               rm "$u" 2>/dev/null
                  ...
                  echo "  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /tmp/.batocera-switch-updater40.sh https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-updater40.sh" >> "$u"
                  ##echo "  curl -sSf https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-updater40.sh -o /tmp/.batocera-switch-updater40.sh " >> "$u"
...
EMULATORS="$(echo $EMULATORS | sed 's/ /-/g')"
   ...
   if [[ ! -f $cfg ]]; then 
      link_defaultconfig=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-config.txt
...
# \\ 
link_tar=https://github.com/phillip9933/batocera-switch/raw/main/system/switch/extra/batocera-switch-tar
link_libselinux=https://github.com/phillip9933/batocera-switch/raw/main/system/switch/extra/batocera-switch-libselinux.so.1
...
#link_ryujinx=https://github.com/phillip9933/batocera.bis/raw/main/switch/extra/ryujinx-1.1.382-linux_x64.tar.gz
#link_ryujinxavalonia=https://github.com/phillip9933/batocera.bis/raw/main/switch/extra/test-ava-ryujinx-1.1.382-linux_x64.tar.gz
...
if [ "$3" = "YUZU" ]; then
T=$THEME_COLOR_YUZU
wget -q --show-progress --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/yuzu1734.AppImage" "https://dl.buzzheavier.com/1849410168739155968?v=1729770736-XGKPMtgwRX7ZXqdXy5CB49rRBSBMszUBzUTqUj7xdZU%3D"
...
# fix broken libstdc++.so.6 for v37 
		   if [[ "$(uname -a | awk '{print $3}')" > "6.2" ]]; then 
			  link_libstdc=https://github.com/phillip9933/batocera-switch/raw/main/system/switch/extra/batocera-switch-libstdc++.so.6
...
wget -q --show-progress --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/yuzuea4176.AppImage" "https://dl.buzzheavier.com/1849410168923705344?v=1729770663-tH6k2tLClUY7x9jhfDXkK1KE95ajIHN%2B7ozVEj5WWSU%3D"
...
wget -q --show-progress --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/ryujinx1403.tar.gz" "https://github.com/ryujinx-mirror/ryujinx/releases/download/r.6253fe1/ryujinx-r.6253fe1-linux_x64.tar.gz"
...
# /userdata/system/switch/extra/ryujinx/ will keep all ryujinx related dependencies
		  ...
		  wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$extra/$emu/xdg-mime" "https://github.com/phillip9933/batocera-switch/raw/main/system/switch/extra/xdg-mime"
		  ###curl -sSf "https://github.com/phillip9933/batocera-switch/raw/main/system/switch/extra/xdg-mime" -o "$extra/$emu/xdg-mime"
...
wget -q --show-progress --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/ryujinxldn313.tar.gz" "https://dl.buzzheavier.com/1849410169091477504?v=1729770455-vjEOaD3NrFDjOVgh%2Fqj5aRXaLn%2BDfGizvzcsOMQxqhc%3D"
...
wget -q --show-progress --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/ryujinxava1403.tar.gz" "https://dl.buzzheavier.com/1849410169074700288?v=1729770535-o5MAXafBEG4rp4k2fb18BuxXQUiOMvLsytUiIuzx8x8%3D"
...
# -------------------------------------------------------------------
# RYUJINXLDN:
#link_ryujinxldn=https://github.com/phillip9933/batocera.bis/raw/main/switch/extra/ava-ryujinx-1.1.0-ldn3.0.1-linux_x64.tar.gz
#link_ryujinxldn=https://github.com/phillip9933/batocera.bis/raw/main/switch/extra/ryujinx-1.1.0-ldn3.0.1-linux_x64.tar.gz
#link_ryujinxldn=https://github.com/phillip9933/batocera.bis/raw/main/switch/extra/ryujinx-1.1.0-ldn3.1.3-linux_x64.tar.gz
## -------------------------------------------------------------------
# RYUJINXAVALONIA:
#link_ryujinxavalonia=https://github.com/Ryujinx/release-channel-master/releases/download/$release_ryujinx/test-ava-ryujinx-$release_ryujinx-linux_x64.tar.gz
#
...
wget -q --show-progress --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/suyu.AppImage" "https://dl.buzzheavier.com/1849410169091477505?v=1729770600-C9HfOscqcEckTMpl6s3nljVyXz6UwYDhhvrZ8NDUBlc%3D"
chmod 777 /userdata/system/switch/*.AppImage 2>/dev/null
# -------------------------------------------------------------------
# get additional files 
# ------------------------------------------------------------------- 
   extraurl="https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra"
# ------------------------------------------------------------------- 
...
#   wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "/userdata/system/switch/configgen/mapping.csv" "https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/configgen/mapping.csv"
...
# -------------------------------------------------------------------
# prepare patcher 
#url_patcher="https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-patcher.sh"
...
url_switchkeys=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/configs/evmapy/switch.keys
url_es_features_switch=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/configs/emulationstation/es_features_switch.cfg
url_es_systems_switch=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/configs/emulationstation/es_systems_switch.cfg
# url_switchlauncher=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/configgen/switchlauncher.py
# url_GeneratorImporter=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/configgen/GeneratorImporter.py
# url_ryujinxMainlineGenerator=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/configgen/generators/ryujinx/ryujinxMainlineGenerator.py
# url_yuzuMainlineGenerator=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/configgen/generators/yuzu/yuzuMainlineGenerator.py
#url_sshupdater=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-sshupdater.sh
url_updater=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-updater40.sh
url_portsupdater=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/roms/ports/Switch%20Updater.sh
url_portsupdaterkeys=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/roms/ports/Switch%20Updater.sh.keys   
...
# url=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/configgen
...
# url=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/configgen/generators
# mkdir -p $path 2>/dev/null
...
# url=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/configgen/generators/yuzu
# mkdir -p $path 2>/dev/null
# wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$path/__init__.py" "$url/__init__.py"
# ##curl -sSf "$url/__init__.py" -o "$path/__init__.py"
...
# url=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/configgen/generators/ryujinx
# mkdir -p $path 2>/dev/null
# wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O "$path/__init__.py" "$url/__init__.py"
# ##curl -sSf "$url/__init__.py" -o "$path/__init__.py"
...
# additional pass for folks who have issues connecting to github
   function get() {
      file="$1"
      path=/userdata/system/switch/configgen/sdl2
      url=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/configgen/sdl2
         mkdir -p $path 2>/dev/null
            if [[ ! -e "$path/$file" ]]; then
               cd $path
...
sdlurl=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-libSDL2.so
   if [[ ! -e "$sdl" ]]; then 
...
urldir="https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra"
icon1url="http://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/icon_updater.png"
icon2url="http://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/icon_loading.png"
...
url=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/translations
mkdir -p $path 2>/dev/null
...
# GET TRANSLATOR
translator=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-translator.sh
...
file=https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-ryujinx-fixes.sh
...
# include display output: 
   ...
   mkdir /userdata/system/switch 2>/dev/null; mkdir /userdata/system/switch/extra 2>/dev/null
      if [[ ( -e "$tput" && "$(wc -c "$tput" | awk '{print $1}')" < "444" ) || ( ! -e "$tput" ) ]]; then
         rm "$tput" 2>/dev/null
         wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /userdata/system/switch/extra/batocera-switch-tput https://github.com/phillip9933/batocera-switch/raw/main/system/switch/extra/batocera-switch-tput
         ##curl -sSf "https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-tput" -o "/userdata/system/switch/extra/batocera-switch-tput"
      fi
      if [[ ( -e "$libtinfo" && "$(wc -c "$libtinfo" | awk '{print $1}')" < "444" ) || ( ! -e "$libtinfo" ) ]]; then
         rm "$libtinfo" 2>/dev/null
         wget -q --tries=10 --no-check-certificate --no-cache --no-cookies -O /userdata/system/switch/extra/batocera-switch-libtinfo.so.6 https://github.com/phillip9933/batocera-switch/raw/main/system/switch/extra/batocera-switch-libtinfo.so.6
         ##curl -sSf "https://raw.githubusercontent.com/phillip9933/batocera-switch/main/system/switch/extra/batocera-switch-libtinfo.so.6" -o "/userdata/system/switch/extra/batocera-switch-libtinfo.so.6"
      fi
